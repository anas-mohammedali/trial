...
dropdown.config(width =30,bg = "#23395d", fg= "White")
...
start_button = tk.Button(window, text = start, width =30,foreground = "white", background = "#23395d", command = bla)
#start_button.place(x = 150 , y = 120)
#start_button.pack()

#Insertion of a stop button --> call of associated function when activated
stop_button = tk.Button(window, text = stop, width =30, foreground = "white", background = "#23395d", command  = bla_bla)
#stop_button.place(x = 300, y = 120)
#stop_button.pack()

#Code for the text_box
label = tk.Label(window, text = info, width =30, font = ('none', 10, "italic", "bold"), foreground = "white", background = "#020202") 
